...
<body class="bg-gradient-to-br from-[#1e1e2f] to-[#2a2a40] scroll-smooth text-white">
  ...
  <header class="bg-[#2c2f48] px-6 py-4 shadow-md flex justify-between items-center sticky top-0 z-50">
    ...
    <nav>
      <ul class="flex gap-6 text-sm font-medium text-white items-center">
        ...
        <li><a href="join.php" class="hover:text-indigo-300 transition">Meetings</a></li>
        <li id="auth-link">
  ...
  <section id="features" class="py-20 px-6 max-w-6xl mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-[#1f1f2e] border border-indigo-500/30 p-6 rounded-xl shadow hover:shadow-xl transition">
        ...
        <p>Group study is a collaborative learning method where students come together to discuss, share, and solve academic concepts. It enhances understanding through peer interaction.</p>
      </div>
      <div class="bg-[#1f1f2e] border border-indigo-500/30 p-6 rounded-xl shadow hover:shadow-xl transition">
  ...
  <footer class="bg-gradient-to-br from-indigo-700 via-indigo-800 to-indigo-900 text-white py-16 px-6">
    <div class="max-w-6xl mx-auto grid md:grid-cols-3 gap-12">
      <div>
        <p class="">Form virtual study groups with classmates to collaborate on projects, discuss topics, and prepare for exams together.</p>
        <h3 class="mt-4 text-2xl font-bold mb-4">PeerConnect 🚀</h3>
